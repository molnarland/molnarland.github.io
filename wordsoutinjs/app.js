...
codeWrite = function() {
  var endColor, endDelay, endWait, retype, startColor, startDelay, startWait, str;
...
$(document).ready(function() {
  ...
  start();
  return inpsirated = new WordsOutIn(document.getElementById("inspirate"), ['Inspirated my friend and npmjs.org'], 200, 0, 'black', false, true);
});
